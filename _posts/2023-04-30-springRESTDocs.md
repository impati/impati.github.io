...
# 들어가며
---
모든 설명을 뒤로한 채 좌우간 모든 기능에 테스트를 수행해야 한다면

테스트를 수행하면서 API 문서 작성까지 할 수 있는 Spring REST Docs 기술을 사용해 보자.
...
- **문서의 정확성과 신뢰성을 보장하는데 도움이 됩니다.**
  
  테스트를 기반으로 문서를 생성하기 때문에 문서를 신뢰할 수 있습니다.
    
- **테스트와 문서화를 동시에**
   문서 작업을 따로 할 필요가 없다는 장점이 있습니다.
